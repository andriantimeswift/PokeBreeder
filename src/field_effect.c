...
static u8 InitFieldMoveMonSprite(u32, u32, u32, u8);
...
{
    s32 spriteId = CreateMonPicSprite(species, 0, 0x8000, TRUE, x, y, 0, gMonPaletteTable[species].tag, 0);
...
u8 CreateMonSprite_FieldMove(u16 species, u32 otId, u32 personality, s16 x, s16 y, u8 subpriority, u8 phenotype)
{
...
bool8 FldEff_FieldMoveShowMon(void)
{
    ...
    gTasks[taskId].tMonSpriteId = InitFieldMoveMonSprite(gFieldEffectArguments[0], gFieldEffectArguments[1], gFieldEffectArguments[2], gFieldEffectArguments[3]);
    return FALSE;
}
...
bool8 FldEff_FieldMoveShowMonInit(void)
{
    ...
    gFieldEffectArguments[3] = GetMonData(pokemon, MON_DATA_PHENOTYPE);
...
static u8 InitFieldMoveMonSprite(u32 species, u32 otId, u32 personality, u8 phenotype)
{
    bool16 noDucking;
    u8 monSprite;
    struct Sprite *sprite;
    ...
    monSprite = CreateMonSprite_FieldMove(species, otId, personality, 320, 80, 0, phenotype);
